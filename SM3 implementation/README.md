使用rust编写的SM3实现,利用了rust方便的包管理与错误处理以及测试功能

执行`cargo test`即可运行所以测试

项目分为compress和lib两个crate
...
![image-20230804165105502](./assets/image-20230804165105502.png)

### 置换函数

![image-20230804165123109](./assets/image-20230804165123109.png)

### 消息扩展

![image-20230804165154908](./assets/image-20230804165154908.png)
...
![image-20230804165220266](./assets/image-20230804165220266.png)

运行测试通过且速度非常快

![image-20230804170055388](./assets/image-20230804170055388.png)
